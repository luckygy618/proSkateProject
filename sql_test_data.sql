...
INSERT INTO product_list(product_id, product_name, image, price, stock_amount, sku, brand, intro, description)
VALUES('S000001', 'CITYBUG ES315D e-Scooter', 'http://timrlai.com/bts530/ES315D-0.jpg', 398.79, 29, 'ES315D', 'CITYBUG', 'CITYBUG ES315D is the most elegant with aerodynamic and modern design eScooter. Equipped with durable and quiet brushless direct current hub motor. It is the perfect way to get from point A to point B, to commute, or just to have a fun ride! It is easy to fold and will fit any size car trunk.This electrical scooter features a quick react acceleration with max speed up to 25km/h and an extremely intuitive thumb control design with just one press then you are good to go. It has 3 riding modes for any skill level.',
...
INSERT INTO product_list(product_id, product_name, image, price, sku, brand, intro, description, stock_status, rating)
VALUES('B000001', 'Flying Eagle Skate Carrier Movement Backpack', 'http://timrlai.com/bts530/FE-Large-Backpack-Movement.jpg',
	59.97, 'FE-A-MOVE', 'Flying Eagle', 'The Flying Eagle Movemement Backpacks are an excellent choice for carrying your skates around, commuting, school, and everyday use. External skate carriers zip away to be hidden when not in use. The back panel has an embroidered Flying Eagle logo and zippers on both sides that result in two separate storage pockets. Padded shoulder straps, laptop storage and simple elegance have made this bag a clear favourite.'
	, 'Colours: Blue, Purple, and Grey@Sizes : Grey – Large, Blueand Purple – Medium','In Stock',5);


INSERT INTO product_list(product_id, product_name, image, price, sku, brand, stock_amount, stock_status, rating, intro, description)
VALUES('F000001', 'Kizer Soulframe 68 Frames', 'http://timrlai.com/bts530/800050_36751_Soulframe_68_SZ4.jpeg', 225.97,
		'800050', 'Kizer', 6, 'In Stock', NULL, 'After the success of the USD Aeon skate, we took a close look at its design in the development of the new Kizer Soulframe 68. We wanted to lower the center of gravity whilst increasing the direct feeling of grinding. It is completely made out of aluminum for maximum energy transfer, faster grinds, and designed specifically for the high-speed park- or bowl skating and coping grinds. Like the Aeon it is a non-UFS unibody soul plate with an integrated frame, to achieve the lowest center of gravity and widest split for flat setups, making it lighter and stronger whilst using fewer parts.Plate and frame are made out of 6061 aircraft aluminum, CNC machined to perfection, and coming with the new Element II aluminum H-block. The Soulframe has predrilled and recessed mounting holes which are compatible fit most USD skates and also Salomons. The 68 version is designed specifically for 68mm and 64mm flat setups, making the Soulframe 68 one of the fastest and most stable flat setups available in modern aggressive skating.'
		, 'Sold in pairs.@Wheels Setup : 4x65mm with UFS mounting or 4x68mm with soulframe mounting@Mount : UFS@Sizes : XL = 276mm@Material : AL 6061 aircraft@Included Accessories : AL spacer, mounting screws, does not incl.mounting antirivets'
	);


INSERT INTO product_list(product_id, product_name, image, price, sku, brand, stock_amount, stock_status, rating, intro, description)
VALUES('WB0001', 'Rossignol X-8 Men’s Race Classic Nordic Ski Boots Black/Red', 'http://timrlai.com/bts530/rik1260_x_8_classic_rgb72dpi_01.jpeg',
	194.97, 'RIK1260', 'Rossignol', NULL, 'In Stock', NULL, 'Train or race. The X8 Classic ski boot is designed for fitness oriented skiers and junior racers. Its race inspired design shares technology with our athlete proven X-ium series to deliver increased precision and power transfer with an accessible flex for fitness and recreational use. The classic specific sole delivers a natural foot roll for an efficient kick, while the locked-in fit and thermo-moldable design provide a precise, enveloped fit to deliver ultimate comfort and control.@Precise Boot Flex, Fit@Dual Core Technology allows targeted boot stiffness for the most responsive feel without a weight penalty@Ski Control, Walkability@The Sport Sole features Tech Grip for comfortable walkingand central insert cleats for maximum precisionand control on the ski@Breathable Warmth@WINTHERM® offers a breathable micro - perforated membrane that reflects heat back towards its source for incredible temperature regulation, comfortand warmth',
	'Please note: due to the brand rules this product does not qualify for a price match nor we are able to offer the PSP Rewards.@Weight: 930 g / pair(size 42)@Sizes : 36 – 49EU@Sole : Sport@Lining : Polyester + Win Therm active membrane@Construction Upper Cuff : Performance PVC@Heel : 3D plastic reinforcement Dual Core'
);



INSERT INTO product_list(product_id, product_name, image, price, sku, brand, stock_amount, stock_status, rating, intro, description)
VALUES('SS00001', 'Powerslide Next Grey Trinity 80', 'http://timrlai.com/bts530/PS-Next-Grey-80.jpg',
	249.97, '908371', 'Powerslide', NULL, 'In Stock', NULL, 'With the Powerslide Next Grey 80 you will be ready for action. The city is full of surprises but The Powerslide NEXT Grey 80 won’t let you down in any situation. These skates are featuring the patented TRINITY mounting system known for amazing power transfer and reactivity, additional control, and improved balance as well as less roll vibration that helps to reduce muscle fatigue.@It’s the third generation of NEXT skates coming with heat moldable MYFIT Recall dual fit liners, which provide premium comfort with the extra layer of memory foam padding.This urban 4 - wheel inline skate is made for both, hair raising actionand relaxed cruising.Elite casted aluminum frames combined with fastand grippy Powerslide Spinner 80mm / 88A wheels and Wicked ABEC 9 freespin bearings.The NEXT Grey 80 is a stunning light grey and purple freeskate for skaters who demand only but the best quality.'
	, 'Perfect for Power Skating, Urban, and Fitness@Shell: Polypropylene, Glass - fiber reinforced plastic(GFRP) – GFK@Closures : Upper Strap, Middle micro - adjustable ratchet buckle, laces@Liners : MYFIT Recall Liner, Heat moldable, Dual Fit@Frame : Powerslide Elite TRINITY 243mm 3x110mm@Frame Mount : Trinity with Lower Center Of Gravity@Wheels : Powerslide Spinner 110mm / 88A Black / Turquoise@Bearings : Wicked ABEC9@Brake : not Included.Optional HABS brake@Weight : 1820g(size 41U)'
);



INSERT INTO product_list(product_id, product_name, image, price, sku, brand, stock_amount, stock_status, rating, intro, description)
VALUES('SS00002', 'FR Skates FR2 310 Black Freeskate', 'http://timrlai.com/bts530/FR-Skates-FR2-310.jpg',
	298.97, 'FRSK-FR2310-BK', 'FR Skates', NULL, 'In Stock', NULL, 'The FR Skates FR2 310 is the perfect skate for FReeride. Thanks to the integrated plates, you will gain in stability and precision. The FR2 is a great skate to improve your skills in all skating styles.',
